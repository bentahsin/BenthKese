...
public final class AnvilGUIHelper {
     ...
     */
    public static void createAmountInput(JavaPlugin plugin, Player player, MessageManager messageManager, String title, ItemStack displayItem, Function<Double, List<AnvilGUI.ResponseAction>> onComplete) {
     ...
     */
    public static void createPlayerInput(JavaPlugin plugin, Player player, MessageManager messageManager, String title, ItemStack displayItem, Function<Player, List<AnvilGUI.ResponseAction>> onComplete) {
        new AnvilGUI.Builder()
                .plugin(plugin)
                .title(title)
                .itemLeft(displayItem)
